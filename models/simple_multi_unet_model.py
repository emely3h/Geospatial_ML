...
def multi_unet_model(n_classes=4, IMG_HEIGHT=256, IMG_WIDTH=256, IMG_CHANNELS=1, dropout=0.1):
    ...
    # 16x16x128(c4), 16x16x128(u6) -> u6 = [16x16x128(u6), 16x16x128(c4)]
    ...
    # 16x16x128(c6) -> 32x32x64(u7)
    u7 = Conv2DTranspose(64, (2, 2), strides=(2, 2), padding="same")(c6)
    # 32x32x64(c3), 32x32x64(u7) -> u7 = [32x32x64(u7), 32x32x64(c3)]
    ...
    # 32x32x64(c7) -> 64x64x32(u8)
    u8 = Conv2DTranspose(32, (2, 2), strides=(2, 2), padding="same")(c7)
    # 64x64x32(c2), 64x64x32(u8) -> u8 = [64x64x32(u8), 64x64x32(c2)]
    ...
    # 64x64x32(c8) -> 128x128x16(u9)
    u9 = Conv2DTranspose(16, (2, 2), strides=(2, 2), padding="same")(c8)
    # 128x128x16(c1), 128x128x16(u9) -> u9 = [128x128x16(u9), 128x128x16(c1)]
    ...
    # 128x128x16(c9) -> 128x128x2(outputs) -> 2 layers: background, foreground
